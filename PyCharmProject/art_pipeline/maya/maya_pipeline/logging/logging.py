...
script_directory = Path(os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe()))))
log_dir:Path = script_directory / "logs"
...
def debug_log(message:str, print_to_script_editor=False):
    '''
    :param message: Message to log
    :param print: Whether to print the log to the Maya Script Editor
    :return:
    '''
    _write_to_log(message, mode=LogMode.DEFAULT, print_to_script_editor=print_to_script_editor)

def debug_warning(message:str, print_to_script_editor=False):
    '''
    :param message: Message to log
    :param print: Whether to print the log to the Maya Script Editor
    :return:
...
def debug_error(message:str, print_to_script_editor=False):
    '''
    :param message: Message to log
    :param print: Whether to print the log to the Maya Script Editor
    :return:
