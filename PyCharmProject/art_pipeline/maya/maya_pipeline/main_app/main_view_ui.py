...
################################################################################
## Form generated from reading UI file 'main_viewmpSETM.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.modelingTab = QWidget()
        self.modelingTab.setObjectName(u"modelingTab")
        self.modelingTab.setEnabled(True)
        self.modeling_tab_vertical_layout = QVBoxLayout(self.modelingTab)
        self.modeling_tab_vertical_layout.setObjectName(u"modeling_tab_vertical_layout")
        self.label = QLabel(self.modelingTab)
        self.label.setObjectName(u"label")
        self.label.setAlignment(Qt.AlignHCenter|Qt.AlignTop)

        self.modeling_tab_vertical_layout.addWidget(self.label)

        self.tabWidget.addTab(self.modelingTab, "")
        self.riggingTab = QWidget()
        self.riggingTab.setObjectName(u"riggingTab")
        self.verticalLayout_3 = QVBoxLayout(self.riggingTab)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.label_2 = QLabel(self.riggingTab)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setAlignment(Qt.AlignHCenter|Qt.AlignTop)

        self.verticalLayout_3.addWidget(self.label_2)

        self.tabWidget.addTab(self.riggingTab, "")
        self.tab = QWidget()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Future Custom Tools TBD", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.modelingTab), QCoreApplication.translate("MainWindow", u"Modeling", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Future Custom Tools TBD", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.riggingTab), QCoreApplication.translate("MainWindow", u"Rigging", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Future Custom Tools TBD", None))
