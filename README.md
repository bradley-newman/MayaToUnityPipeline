...
The function returns a `DockableMainWindow` object. The `ui_main_window` argument should be a reference to the `Ui_MainWindow` class generated by Qt Designer.
